...
4) Use "help" command to figure out what the hell you want to do 
   ...
   - When loading settings file, settings are not automatically updated to devices,
     so you should reinitialize them via the init commands to update the devices.
