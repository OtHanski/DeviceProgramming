...
def HistLimits(Waveform):
    ...
    # Add slider to adjust signal limit
    maxV = max(abs(Waveform[1]))
    offset_Slider = Slider(offset_ax, "Signal limit", valmin = -maxV, valmax = 0.2*maxV, valinit=0.0,orientation ="vertical")
